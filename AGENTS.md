...
- **Scope discipline:** work the current milestone only. `PROJECT_STATUS.md` and
  `docs/roadmap.md` say where we are. Milestones 1–16 (Platform Foundation,
  ...
  `docs/assessment-management.md`, Results & Report Cards —
  `docs/results-report-cards.md`, Parent Portal — `docs/parent-portal.md`)
  are done.
