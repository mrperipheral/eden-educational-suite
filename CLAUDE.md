...
Tracked in `PROJECT_STATUS.md` and `docs/roadmap.md`. **Milestones 1–14 (Platform
...
Assignments) are complete.** School settings: `docs/school-settings.md`; module
...
assignments: `docs/assessment-management.md`. Do not start any further domain
module (results & report cards, fees, CBT, notifications, promotion, portals, …)
without picking up the next milestone explicitly.
