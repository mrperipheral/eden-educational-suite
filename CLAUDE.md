...
Tracked in `PROJECT_STATUS.md` and `docs/roadmap.md`. **Milestones 1–9 (Platform
...
Academic Foundation, Student Management) are complete.** School settings:
...
`docs/student-management.md`. Do not start any further domain module (guardians,
staff, timetable, attendance, fees, results, CBT, notifications, promotion,
